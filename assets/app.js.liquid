...
$(".js-scroll-into-view").click(function() {
var x=$(this).data("target");console.log(x)
...
jQuery('.js-ingred').hover(function(){
var xx=jQuery(this).data('index');
jQuery("#ingredients li").addClass("hidden");
jQuery("#ingredients").find('li').eq(xx).removeClass("hidden")
})
}
...
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function() {
    ...
    if (panel.style.display === "block") {
      ...
      panel.classList.toggle("max-h-800");
    } else {
